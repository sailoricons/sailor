...
test('replaces [data-sailor] elements with SVG markup', () => {
  document.body.innerHTML =
    '<i data-sailor="icon1"></i><span data-sailor="icon2"></i>';
...
test('copies placeholder element attributes to <svg> tag', () => {
  document.body.innerHTML =
    '<i data-sailor="icon1" id="test" class="foo bar" stroke-width="1"></i>';
  expect(document.body.innerHTML).toMatchSnapshot();
  replace();
  expect(document.body.innerHTML).toMatchSnapshot();
});
